...
<div class="container">
  <div class="card border-0 shadow my-5">
	...
	<h1>LDAP y bajas de empleados: Carga de archivos</h1>
        ...
        El archivo seleccionado NO utiliza el formato LDAP. Favor de intentar nuevamente
	...
	<script>
        ...
        <form name='loginFr' action="/NomURL/admin" method='GET'>

        
        <input type = "submit" value = "Cargar otro archivo"/>
