...
<div class="container">
  <div class="card border-0 shadow my-5">
    ...
    function fileValidation(){
        ...
        var allowedExtensions2 = /WO_VPN_\d{8}(.csv)$/;
        ...
        if(!allowedExtensions2.exec(filePath)){
            ...
            document.getElementById('demo').innerHTML = '<div class="alert alert-primary" role="alert">Archivo de bajas VPN seleccionado</div>';
    ...
    <h1>BAJAS VPN: Carga de archivos </h1>


    
    <form:form action="/BajasVPN/admin" method = "POST" modelAttribute = "fileUpload"
